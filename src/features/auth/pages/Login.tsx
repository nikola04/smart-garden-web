...
import { getGoogleLoginURL } from "../services/google"
                    ...
                    <form onSubmit={form.handleSubmit(handleSubmit)}>
                        <div className="grid gap-6">
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            <div className="flex justify-between items-center">
                                                ...
                                                <Link to="/auth/forgot_pswd" className="text-xs/1"><span className="text-xs/0 text-primary">Forgot your password?</span></Link>
                                            </div>
                                            <FormControl>
                            ...
                            <div className="relative text-center after:absolute after:inset-0 after:top-1/2 after:z-0 after:flex after:items-center after:border-t after:border-border">
                                <span className="relative z-10 bg-background px-2 text-muted-foreground font-light text-sm">or continue with</span>
                            </div>
